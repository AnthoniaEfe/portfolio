...
export default function Service() {
  return (
    ...
    <span className="flex justify-start items-center gap-4 my-8 md:my-14 " >
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mx-auto my-4 px-2 justify-between items-center">
        {panelsData.map((panel, index) => (
          <div key={index} className="border-[1px] border-textblack rounded-2xl h-full p-6 md:p-8 gap-4 md:gap-6 flex flex-col justify-between items-start" >
