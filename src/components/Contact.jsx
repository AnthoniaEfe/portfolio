...
export default function Contact() {
  ...
  return (
      <div id="contact"
       className=' justify-around px-8 md:px-20 lg:px-24 gap-16 py-6 md:py-10 lg:py-20 flex flex-col items-left font-mono mt-30'>
        <h2 className='text-left text-textblack md:text-5xl '>Say Hello!</h2>
